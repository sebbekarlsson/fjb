...
AST_T* parser_parse_factor(parser_T* parser, parser_options_T options)
{
  ...
  switch (parser->token->type) {
    case TOKEN_ID: case TOKEN_CATCH: case TOKEN_ELSE: case TOKEN_FROM: case TOKEN_FOR: return parser_parse_id(parser, options); break; 
    case TOKEN_DIV: return parser_parse_regex(parser, options); break; 
    ...
    case TOKEN_RETURN: case TOKEN_DELETE: case TOKEN_EXPORT: case TOKEN_TYPEOF: case TOKEN_NEW: case TOKEN_THROW: case TOKEN_BREAK: case TOKEN_INSTANCEOF: case TOKEN_VOID: case TOKEN_ASYNC: case TOKEN_AWAIT: case TOKEN_ASSERT: return parser_parse_state(parser, options); break;
    case TOKEN_CONST: case TOKEN_LET: case TOKEN_VAR: return parser_parse_definition(parser, options); break;
...
AST_T* parser_parse_statement(parser_T* parser, parser_options_T options)
{
  ...
  switch (parser->token->type)
  {
    case TOKEN_IMPORT: left = parser_parse_import(parser, options); break;
    case TOKEN_FOR: left = parser_parse_for(parser, options); break;
    case TOKEN_CASE: left = parser_parse_case(parser, options); break;
    case TOKEN_IF: case TOKEN_ELSE: left = parser_parse_condition(parser, options); break;
    case TOKEN_TRY: left = parser_parse_try(parser, options); break;
    case TOKEN_WHILE: left = parser_parse_while(parser, options); break;
    case TOKEN_RETURN: case TOKEN_DELETE: case TOKEN_EXPORT: case TOKEN_THROW: case TOKEN_BREAK: case TOKEN_VOID: case TOKEN_ASYNC: case TOKEN_AWAIT: case TOKEN_ASSERT: return parser_parse_state(parser, options); break;
